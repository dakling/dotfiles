...
globalkeys = gears.table.join(
  ...
  awful.key({ modkey,           }, "e", revelation,
            {description = "open revelation", group = "launcher"}),
...
mousemodekeys = gears.table.join(
  ...
  awful.key({  }, "r",   function()   awful.spawn("xdotool click --repeat 2 1") end,
            {description="double click", group="awesome"}),
...
-- autostart
autostartWithCheck = function(programName)
  awful.spawn("startIfNotRunning " .. programName)
end
