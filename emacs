...
")))
  ...
  (use-package omnisharp
    ...
    (my-local-leader-def
      ...
      "nfj" '(csharp-move-back-to-beginning-of-defun :which-key "navigate to beginning of function")
      "nfk" '(csharp-move-fwd-to-end-of-defun :which-key "navigate to end of function")
      "nc" '('ignore :which-key "class")
      "ncj" '(csharp-move-back-to-beginning-of-class :which-key "navigate to beginning of class")
      "nck" '(csharp-move-fwd-to-end-of-class :which-key "navigate to end of class")
      "nb" '('ignore :which-key "block")
      "nbj" '(csharp-move-back-to-beginning-of-block :which-key "navigate to beginning of block")
